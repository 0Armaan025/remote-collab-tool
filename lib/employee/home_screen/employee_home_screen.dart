                ...
                child: Column(children: [
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: 'Enter Orgainization ID',
                      ...
                      FirebaseFirestore.instance
                        ...
                        if (value.data() != null) {
                          ...
                          FirebaseFirestore.instance
                              ...
                              .doc(orgIDController.text)
                              .update({
                            "Employees": FieldValue.arrayUnion([uid!]),
                          });
                          setState(() {
                            orgID = orgIDController.text;
                            sharedPreferences!
                                .setString("orgID", orgIDController.text);
                          });
                        }
                      });
                    },
